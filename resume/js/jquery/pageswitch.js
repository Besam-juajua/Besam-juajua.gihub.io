(function ($) {
	...
	// 开始浏览
	$($('.btn-group button')[0]).on('click', function () { 
		iIndex = 1;
		scrollPage(arrElement[iIndex]);
	})

	// 开始浏览
	$($('.btn-group button')[1]).on('click', function () { 
		iIndex = 5;
		scrollPage(arrElement[iIndex]);
	})
	...
	function scrollPage(element) {
		...
		$($('.nav-list li')[iIndex]).addClass('active');
